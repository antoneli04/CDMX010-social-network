...
/* <header class="container-home-head" id="home-mobile">
    ...
    <div class="div-search-head">
        ...
        <img class="icon-home-head" src="../assets/icon-exit.png" alt="Salir">
    </div>
</header>
<main class="container-home">
    ...
    <div class="container-img"> 
        <img class="img-post-home" src="../assets/cafeImg.jpg">
    </div>
    ...
    Mi lugar favorito para probar café en la cafetería Kayrom, que se encuentra a unos paso del centro historico</p>
        ...
        <form class="form-comments">
            <input class="post-comment" placheholder="Comenta algo">
